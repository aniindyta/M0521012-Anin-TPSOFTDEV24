            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-horizontal" action="/book-edit{{$book->id}}" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="name" class="form-control" name="name" value="{{$book->first()->name}}"
                                                placeholder="Name">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" id="year" class="form-control" name="year" value="{{$book->first()->year}}"
                                                placeholder="Year">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" id="stock" class="form-control" name="stock" value="value="{{$book->stock}}""
                                                placeholder="Stock">
                                        </div>                                       
                                        <div class="col-md-4">
